...
System.out.println("This school year is much more difficult than last year.");
  /*
...
// The integr mNu, is et to 30, then it is set to return the value of the method "doubleNumber" after inputing "myNum" as the argument.
  int myNum = 30;
 ...
 //Explain what is happening
  ...
  // The system is outputting the method "doubleNumber" with the argument being set to 5 .
